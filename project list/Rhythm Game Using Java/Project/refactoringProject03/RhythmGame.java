...
public class RhythmGame extends JFrame {
	...
	public RhythmGame() { // 객체가 생성되면 화면/사용자 인터페이스, 음악실행, 게임 실행 등등..
		...
		leftButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) { quitButton.setIcon(leftButtonImage); } // -> 이미지 추가하자
			@Override
		...
		rightButton.addMouseListener(new MouseAdapter() {
			@Override 
			public void mouseEntered(MouseEvent e) { quitButton.setIcon(rightButtonImage); } // -> 이미지 추가하자
			@Override
