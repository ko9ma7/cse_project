...
public class Game extends Thread { // 하나의 게임은 하나의 단위로 움직여야 되므로 클래스를 생성
	...
	private Image noteRouteLineImage = new ImageIcon(Parameter.PATH + "noteRouteLine.jpg").getImage(); // 노트가 이동하는 라인
	private Image judgementLineImage = new ImageIcon(Parameter.PATH + "judgementLine.jpg").getImage(); // 노트 판정선
	private Image gameInfoImage = new ImageIcon(Parameter.PATH + "gameInfo.jpg").getImage(); 			// 게임 화면 전환 후, 하단에 정보 표시
	private Image noteRouteSImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	private Image noteRouteDImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	private Image noteRouteFImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	private Image noteRouteSpace1Image = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	private Image noteRouteSpace2Image = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); 
	private Image noteRouteJImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	private Image noteRouteKImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); 
	private Image noteRouteLImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	...
	ArrayList<Note> noteList = new ArrayList<Note>(); // 노트의 집합
	...
	public void setGame(String t, String d) {
		this.tName = t;
		this.difficulty = d;
		this.music = new Music(tName + ".mp3", false);
	}
	...
	public void screenDraw(Graphics2D g) {
		...
		g.drawString(tName + ".mp3", 20, 702); 		 // 곡명
	...
	public void pressS() { 
		judge("S"); // S에 대한 판정
		noteRouteSImage = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseS() { noteRouteSImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); }
	
	public void pressD() { 
		judge("D"); // D에 대한 판정
		noteRouteDImage = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseD() { noteRouteDImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); }
	
	public void pressF() {
		judge("F"); // F에 대한 판정
		noteRouteFImage = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseF() { noteRouteFImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); }
	
	public void pressSpace() {
		judge("Space"); // Space에 대한 판정
		noteRouteSpace1Image = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
		noteRouteSpace2Image = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseSpace() { 
		noteRouteSpace1Image = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
		noteRouteSpace2Image = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage();
	}
	
	public void pressJ() {
		judge("J"); // J에 대한 판정
		noteRouteJImage = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseJ() { noteRouteJImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); }
	
	public void pressK() {
		judge("K"); // K에 대한 판정
		noteRouteKImage = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseK() { noteRouteKImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); }
	
	public void pressL() { 
		judge("L"); // L에 대한 판정
		noteRouteLImage = new ImageIcon(Parameter.PATH + "noteRoutePressed.jpg").getImage();
	}
	public void releaseL() { noteRouteLImage = new ImageIcon(Parameter.PATH + "noteRoute.jpg").getImage(); }
	...
	public void judgeImageEvent(String judge) {
		...
		if (judge.equals("None")) {
			...
			judgeImage = new ImageIcon(Parameter.PATH + "judgeMissImage.JPG").getImage();
			...
			judgeImage = new ImageIcon(Parameter.PATH + "judgeTooLateImage.JPG").getImage();
				
		} else if (judge.equals("So So")) {
				
			judgeImage = new ImageIcon(Parameter.PATH + "judgeSoSoImage.JPG").getImage();
				
		} else if (judge.equals("Good")) {
				
			judgeImage = new ImageIcon(Parameter.PATH + "judgeGoodImage.JPG").getImage();
				
	    } else if (judge.equals("Great")) {
				
			judgeImage = new ImageIcon(Parameter.PATH + "judgeGreatImage.JPG").getImage();
				
		} else if (judge.equals("Exellent")) {
				
			judgeImage = new ImageIcon(Parameter.PATH + "judgeExellentImage.JPG").getImage();
		
		} else if (judge.equals("Perfect")) {
				
			judgeImage = new ImageIcon(Parameter.PATH + "judgePerfectImage.JPG").getImage();
				
		} else if (judge.equals("Too fast")) {
				
			judgeImage = new ImageIcon(Parameter.PATH + "judgeTooFastImage.JPG").getImage();
