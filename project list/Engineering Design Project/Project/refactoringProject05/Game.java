...
public class Game extends Thread { // 하나의 게임은 하나의 단위로 움직여야 되므로 클래스를 생성
	...
	private Image judgeImage; // judgeImage 변수 생성
	int startTime;
	int gap;
	
	protected JudgeEasyStrategy strategy;
	...
	@Override
	public void run() { dropNote(this.tName); }
	...
	public void dropNote(String titleName) {
		...
		if (titleName.equals("Limitless") && difficulty.equals("Easy")) {
			startTime = 1000 - Parameter.REACH_TIME.getValue() * 1000;
			gap = 500;
		...
		} else if (titleName.equals("Limitless") && difficulty.equals("Hard")) {
			...
			beats = new Beat[] {
					...
					new Beat(startTime - gap, "S"), new Beat(startTime + gap * 2, "D"),
					new Beat(startTime + gap * 4, "F"), new Beat(startTime + gap * 6, "D"),

					new Beat(startTime + gap * 8, "S"), new Beat(startTime + gap * 10, "D"),
					new Beat(startTime + gap * 12, "F"), new Beat(startTime + gap * 14, "D"),

					new Beat(startTime + gap * 16, "S"), new Beat(startTime + gap * 17, "D"),
					new Beat(startTime + gap * 18, "F"), new Beat(startTime + gap * 19, "D"),

					new Beat(startTime + gap * 20, "S"), new Beat(startTime + gap * 22, "D"),
					new Beat(startTime + gap * 24, "F"),

					// 26부터
					new Beat(startTime + gap * 26, "L"), new Beat(startTime + gap * 28, "K"),
					new Beat(startTime + gap * 30, "J"), new Beat(startTime + gap * 32, "K"),

					new Beat(startTime + gap * 33, "L"), new Beat(startTime + gap * 34, "K"),
					new Beat(startTime + gap * 35, "J"),

					new Beat(startTime + gap * 40, "J"), new Beat(startTime + gap * 42, "K"),
					new Beat(startTime + gap * 44, "L"), new Beat(startTime + gap * 46, "K"),
					new Beat(startTime + gap * 47, "J"),

					new Beat(startTime + gap * 49, "S"), new Beat(startTime + gap * 50, "D"),
					new Beat(startTime + gap * 51, "F"), new Beat(startTime + gap * 52, "J"),
					new Beat(startTime + gap * 53, "K"), new Beat(startTime + gap * 54, "L"),

					// 55부터
					new Beat(startTime + gap * 55, "Space"), new Beat(startTime + gap * 57, "Space"),
					new Beat(startTime + gap * 59, "Space"), new Beat(startTime + gap * 61, "Space"),
					new Beat(startTime + gap * 63, "Space"), new Beat(startTime + gap * 65, "Space"),
					new Beat(startTime + gap * 67, "Space"),

					new Beat(startTime + gap * 69, "S"), new Beat(startTime + gap * 71, "L"),
					new Beat(startTime + gap * 73, "F"), new Beat(startTime + gap * 75, "J"),
					...
					// 84부터
					new Beat(startTime + gap * 84, "Space"), new Beat(startTime + gap * 86, "Space"),
					new Beat(startTime + gap * 88, "Space"), new Beat(startTime + gap * 90, "Space"),
					new Beat(startTime + gap * 92, "Space"),
					...
					new Beat(startTime + gap * 99, "S"), new Beat(startTime + gap * 99, "L"),
					new Beat(startTime + gap * 99, "F"), new Beat(startTime + gap * 99, "J"),
					...
					// 117부터 시작
					new Beat(startTime + gap * 117, "J"), new Beat(startTime + gap * 118, "J"),
					new Beat(startTime + gap * 119, "J"), new Beat(startTime + gap * 120, "J"),
					new Beat(startTime + gap * 121, "J"), new Beat(startTime + gap * 122, "J"),

					new Beat(startTime + gap * 124, "F"), new Beat(startTime + gap * 125, "F"),
					new Beat(startTime + gap * 126, "F"), new Beat(startTime + gap * 127, "F"),
					new Beat(startTime + gap * 128, "F"), new Beat(startTime + gap * 129, "F"),

					new Beat(startTime + gap * 131, "K"), new Beat(startTime + gap * 132, "K"),
					new Beat(startTime + gap * 133, "K"), new Beat(startTime + gap * 134, "K"),
					new Beat(startTime + gap * 135, "K"), new Beat(startTime + gap * 136, "K"),

					new Beat(startTime + gap * 138, "D"), new Beat(startTime + gap * 139, "D"),
					new Beat(startTime + gap * 140, "D"), new Beat(startTime + gap * 141, "D"),
					new Beat(startTime + gap * 142, "D"), new Beat(startTime + gap * 143, "D"),

					// 다시 한번 반복
					new Beat(startTime + gap * 144, "Space"),

					new Beat(startTime + gap * 145, "L"), new Beat(startTime + gap * 146, "L"),
					new Beat(startTime + gap * 147, "L"), new Beat(startTime + gap * 148, "L"),
					new Beat(startTime + gap * 149, "L"), new Beat(startTime + gap * 150, "L"),

					new Beat(startTime + gap * 152, "Space"),

					new Beat(startTime + gap * 154, "S"), new Beat(startTime + gap * 155, "S"),
					new Beat(startTime + gap * 156, "S"), new Beat(startTime + gap * 157, "S"),
					new Beat(startTime + gap * 158, "S"), new Beat(startTime + gap * 159, "S"),

					new Beat(startTime + gap * 161, "J"), new Beat(startTime + gap * 162, "J"),
					new Beat(startTime + gap * 163, "J"), new Beat(startTime + gap * 164, "J"),
					new Beat(startTime + gap * 165, "J"), new Beat(startTime + gap * 166, "J"),

					new Beat(startTime + gap * 168, "Space"),

					new Beat(startTime + gap * 169, "F"), new Beat(startTime + gap * 170, "F"),
					new Beat(startTime + gap * 171, "F"), new Beat(startTime + gap * 172, "F"),
					new Beat(startTime + gap * 173, "F"), new Beat(startTime + gap * 174, "F"),

					// 175부터 시작
					new Beat(startTime + gap * 175, "S"), new Beat(startTime + gap * 177, "J"),
					new Beat(startTime + gap * 179, "D"), new Beat(startTime + gap * 181, "K"),
					new Beat(startTime + gap * 183, "F"), new Beat(startTime + gap * 185, "L"),
					new Beat(startTime + gap * 187, "J"), new Beat(startTime + gap * 189, "F"),
					new Beat(startTime + gap * 191, "K"), new Beat(startTime + gap * 193, "D"),
					new Beat(startTime + gap * 195, "L"), new Beat(startTime + gap * 197, "S"),
					new Beat(startTime + gap * 199, "K"), new Beat(startTime + gap * 201, "D"),
					new Beat(startTime + gap * 203, "J"), new Beat(startTime + gap * 205, "F"),
					new Beat(startTime + gap * 207, "L"), new Beat(startTime + gap * 209, "S"),

					new Beat(startTime + gap * 210, "S"), new Beat(startTime + gap * 211, "J"),
					new Beat(startTime + gap * 213, "D"), new Beat(startTime + gap * 215, "K"),
					new Beat(startTime + gap * 217, "F"), new Beat(startTime + gap * 219, "L"),
					new Beat(startTime + gap * 221, "J"), new Beat(startTime + gap * 223, "F"),
					new Beat(startTime + gap * 225, "K"), new Beat(startTime + gap * 227, "D"),
					new Beat(startTime + gap * 229, "L"), new Beat(startTime + gap * 231, "S"),
					new Beat(startTime + gap * 233, "K"), new Beat(startTime + gap * 235, "D"),
					new Beat(startTime + gap * 236, "Space"), new Beat(startTime + gap * 237, "J"),
					new Beat(startTime + gap * 238, "Space"), new Beat(startTime + gap * 239, "F"),
					new Beat(startTime + gap * 240, "Space"), new Beat(startTime + gap * 241, "L"),
					new Beat(startTime + gap * 242, "Space"), new Beat(startTime + gap * 243, "S"),
					...
					new Beat(startTime + gap * 269, "K"), new Beat(startTime + gap * 270, "Space"),
					new Beat(startTime + gap * 271, "D"), new Beat(startTime + gap * 272, "Space"),
					new Beat(startTime + gap * 273, "J"), new Beat(startTime + gap * 273, "Space"),
					new Beat(startTime + gap * 274, "Space"), new Beat(startTime + gap * 275, "F"),
					new Beat(startTime + gap * 275, "Space"), new Beat(startTime + gap * 276, "Space"),
					new Beat(startTime + gap * 277, "L"), new Beat(startTime + gap * 277, "Space"),
					new Beat(startTime + gap * 278, "Space"), new Beat(startTime + gap * 279, "S"),
					new Beat(startTime + gap * 279, "Space"), new Beat(startTime + gap * 280, "Space"),

					new Beat(startTime + gap * 281, "Space"), new Beat(startTime + gap * 281 + 125, "Space"),
					new Beat(startTime + gap * 282, "Space"), new Beat(startTime + gap * 282 + 125, "Space"),
					new Beat(startTime + gap * 283, "Space"), new Beat(startTime + gap * 283 + 125, "Space"),
					new Beat(startTime + gap * 284, "Space"), new Beat(startTime + gap * 284 + 125, "Space"),
					new Beat(startTime + gap * 285, "Space"), new Beat(startTime + gap * 285 + 125, "Space"),
					new Beat(startTime + gap * 286, "Space"), new Beat(startTime + gap * 286 + 125, "Space"),
					new Beat(startTime + gap * 287, "Space"), new Beat(startTime + gap * 287 + 125, "Space"),
					new Beat(startTime + gap * 288, "Space"), new Beat(startTime + gap * 288 + 125, "Space"),

					new Beat(startTime + gap * 290, "S"), new Beat(startTime + gap * 290, "F"),
					new Beat(startTime + gap * 290, "J"), new Beat(startTime + gap * 290, "L"),
					new Beat(startTime + gap * 291, "S"), new Beat(startTime + gap * 291, "F"),
					new Beat(startTime + gap * 291, "J"), new Beat(startTime + gap * 291, "L"),
					new Beat(startTime + gap * 292, "Space"),
	...
	public void judge(String nType) { // 노트 판정 함수
		for (int i = 0; i < noteList.size(); i++) { // 노트 리스트에서 첫 번째부터 검수한다(큐와 같은 느낌)
			Note note = noteList.get(i);
			strategy = new EasyStrategy(nType, difficulty);
			...
			if (nType.equals(note.getNoteType())) { // 만약 노트 타입이 같으면 실행
				...
				try {
					note.strategy.judge(); // 노트의 위치에 따른 판정
				} catch(Exception e) {
					e.getMessage();
				}
/*				try {
					
					judgeImageEvent(note.strategy.judge());
					
				} catch(Exception e) {
					e.getMessage();
				}
*/				if (note.score == 0) score = 0;
				else score += note.score;
				break;
			} 
		}		
	}
	...
	// 노트의 판정 image 이벤트 처리 
	public void judgeImageEvent(String judge) {
		
		if (judge.equals("None")) {
			
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeMissImage.JPG")).getImage();
			
		} else if (judge.equals("Miss")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeMissImage.JPG")).getImage();
				
		} else if (judge.equals("Too late")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeTooLateImage.JPG")).getImage();
				
		} else if (judge.equals("So So")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeSoSoImage.JPG")).getImage();
				
		} else if (judge.equals("Good")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeGoodImage.JPG")).getImage();
				
	    } else if (judge.equals("Great")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeGreatImage.JPG")).getImage();
				
		} else if (judge.equals("Exellent")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeExellentImage.JPG")).getImage();
		
		} else if (judge.equals("Perfect")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgePerfectImage.JPG")).getImage();
				
		} else if (judge.equals("Too fast")) {
				
			judgeImage = new ImageIcon(Main.class.getResource("../images/judgeTooFastImage.JPG")).getImage();
