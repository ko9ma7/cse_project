...
def parseScreenshot(driver, user_name, keyword):
    ...
    # 통합된 스크린 샷 통합해서 저장하기
    stitched_image.save('C:/Users/battl/PycharmProjects/ComputerScienceEngineering/project list/Graduation Project/Selenium/screenshot/' + user_name + '_' + keyword + '.png')
    # 바이너리 형태로 파일 저장하기
    output = io.BytesIO()
