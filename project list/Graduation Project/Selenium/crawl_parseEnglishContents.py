...
class SentenceTokenizer(object):
    def __init__(self):
        ...
        # 영어 불용어 엑셀 파일을 로드
        self.load_wb = load_workbook('C:/Users/battl/PycharmProjects/ComputerScienceEngineering/project list/Graduation Project/Selenium/excel/english_stopwords.xlsx')
