...
def make_excel(user_name, keyword):
    ...
    # 엑셀 파일 저장 위치
    excel_file_path = 'C:/Users/battl/PycharmProjects/ComputerScienceEngineering/project list/Graduation Project/Selenium/excel/'
    # 엑셀 파일 이름
...
def crawl_saveExcel(user_name, user_email, curr_url, prev_url, pageList, relativeKeywordList, level, paths, keyword, sub_keyword, pageContents, memo, tagged, nowTime):
    ...
    for idx, info_values in enumerate(crawl_info_values):
        ...
        # elif idx == 14:
        #     png_loc = 'C:/Users/battl/PycharmProjects/ComputerScienceEngineering/project list/Graduation Project/Selenium/screenshot/' + user_name + '_' + keyword + '.png'
